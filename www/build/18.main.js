...
var MenuPage = (function () {
    function MenuPage(navCtrl, navParams) {
        ...
        this.pages = [
            ...
            { title: 'Dice', pageName: 'TabsPage', tabComponent: 'DicerollerPage', index: 1, icon: 'ios-help-circle' },
            { title: 'Initiative', pageName: 'TabsPage', tabComponent: 'ExperiencePage', index: 2, icon: 'ios-people' },
            { title: 'Timer', pageName: 'TabsPage', tabComponent: 'SkillsPage', index: 3, icon: 'ios-stopwatch' },
        ];
    }
